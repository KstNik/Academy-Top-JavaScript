...
Задание. Разработка сайта с сервисом полезных функций, или интерактивно-развлекательного характера (например простая игрушка).
Обязательно с использованием библиотеки jQuery.
Опционально можно подключать любые фреймворки.
